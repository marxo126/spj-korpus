...
RH+LH prepartner-dictns are **auto-paired** into review units when they overlap ≥100ms. The annotator reviews one unit at a time.
...
**Timeline:** `active_pred_indices` highlights all prepartner-dictns in the current unit simultaneously. Trims and cuts apply to all active prepartner-dictns.
