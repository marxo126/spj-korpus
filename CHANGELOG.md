...
### Added
- Dual-view video splitting for Kodifikacia — extract poses from both 60° and 90° camera angles separately
...
- Standalone script `tools/split_kodifikacia_poses.py` for batch dual-view extraction
- "Split dual-view" checkbox in Page 2 (Pose Extraction) — auto-filters to Kodifikacia videos
