...
Combines video player, pose canvas, and interactive prepartner-dictn timeline
into a single component. Returns user actions (trim changes, prepartner-dictn
...
def spj_timeline(
    *,
    ...
    result = _component_func(
        ...
        prepartner-dictns=prepartner-dictns,
