...
| `inference.py` | Run predictions, write to EAF AI tiers |
...
| `spreadthesign.py` | reference dictionary dictionary download |
...
Training data: 13,638 NPZ segments from dictionary videos (10K) + category vocabulary (4.7K).
...
[InnoSign](https://www.innosign.eu)
